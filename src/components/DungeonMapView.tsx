...
const POS: [number, number][] = [
  ...
  [152, 62], // 15 neurogenesis_spire  — Iglica Neurogenezy
  [146, 78], // 16 antimatter_foundry  — Kuźnia Antymaterii
  [128, 78], // 17 eventide_rift        — Szczelina Zmierzchu
  [110, 80], // 18 oblivion_datavault   — Skarbiec Zapomnienia
  [96,  68], // 19 genesis_singularity  — Singularność Genezy
];
  ...
  return (
    ...
    >
      ...
      <svg viewBox={`0 0 ${W} ${H}`} width="100%" height="100%" style={{ display: 'block' }}>
        <defs>
          <filter id="dm-glow" x="-200%" y="-200%" width="500%" height="500%" color-interpolation-filters="sRGB">
