                ...
                <div key={i} style={{
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <p style={{ ...MONO, fontSize: 10, color: `${rc}99` }}>
                      {rarityLabel[item.rarity]} · {t.common.lvlShort} {item.level}
                    </p>
                  </div>
  ...
  return (
    <div className="card p-3" style={{ display: 'flex', flexDirection: 'column', gap: 10, background: 'rgba(6,6,18,0.97)' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {t.common.lvlShortCaps} {boss!.level}
          </div>
        </div>
        ...
        {/* Powers */}
        <div style={{ width: '100%' }}>
          <p style={{ ...MONO, fontSize: 10, color: 'var(--text-muted)', marginBottom: 6 }}>{t.challenge.bossPowers}</p>
      ...
      {cooldownLeft > 0 ? (
        ...
        >
          <GameIcon name="lightning" size={11} color="#fff" /> {t.challenge.fightBoss} {boss!.name.toUpperCase()}
        </button>
      )}
    </div>
  );
