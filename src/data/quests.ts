...
export const ALL_QUESTS: Quest[] = [
  ...
  { id: 'megacorp',     name: 'Infiltracja Megacorp', nameEn: 'Megacorp Infiltration', description: 'Wnikaj do kwatery głównej megakorporacji i wykradnij protokół.', descEn: 'Infiltrate the megacorporation HQ and steal the master protocol.',      durationMs: 1_800_000, xpReward: 2500, goldReward: 2200, minLevel: 30, emoji: '🏢' },
  { id: 'singularity_protocol', name: 'Protokół Singularności', nameEn: 'Singularity Protocol', description: 'Powstrzymaj aktywację kwantowego AI zanim przekształci rzeczywistość.', descEn: 'Stop the quantum AI activation before it reshapes reality.',     durationMs: 2_700_000, xpReward: 4000, goldReward: 3500, minLevel: 45, emoji: '🌌' },
];
