...
export const ENEMY_TIERS: EnemyTemplate[][] = [
  // Tier 1 (piętro 1–2)
  [
    { id: 'blood_shadow',  name: 'Cień Krwi',      emoji: '👻', hpMult: 0.6, atkMult: 0.14, defMult: 0.20, baseXp: 22, baseGold: 16 },
    { id: 'bone_man',      name: 'Kościan',        emoji: '💀', hpMult: 0.7, atkMult: 0.12, defMult: 0.28, baseXp: 24, baseGold: 14 },
    { id: 'rotten_rat',    name: 'Gnijący Szczur', emoji: '🐀', hpMult: 0.5, atkMult: 0.16, defMult: 0.10, baseXp: 20, baseGold: 20 },
  ],
  // Tier 2 (piętro 3–4)
  [
    { id: 'specter',       name: 'Widmo',         emoji: '🌫️', hpMult: 0.8, atkMult: 0.18, defMult: 0.28, baseXp: 38, baseGold: 30 },
    { id: 'undead_knight', name: 'Trupi Rycerz', emoji: '⚔️', hpMult: 0.9, atkMult: 0.16, defMult: 0.38, baseXp: 44, baseGold: 27 },
    { id: 'necromancer',   name: 'Nekromanta',   emoji: '🧙', hpMult: 0.8, atkMult: 0.20, defMult: 0.20, baseXp: 42, baseGold: 33 },
  ],
  // Tier 3 (piętro 5–6)
  [
    { id: 'abyss_demon',    name: 'Demon Otchłani', emoji: '😈', hpMult: 1.0, atkMult: 0.21, defMult: 0.36, baseXp: 60, baseGold: 50 },
    { id: 'undead_mage',    name: 'Nieumarły Mag',  emoji: '🔮', hpMult: 0.9, atkMult: 0.23, defMult: 0.28, baseXp: 64, baseGold: 54 },
    { id: 'crypt_guardian', name: 'Strażnik Krypt', emoji: '🗿', hpMult: 1.2, atkMult: 0.19, defMult: 0.50, baseXp: 66, baseGold: 45 },
  ],
  // Tier 4 (piętro 7–8)
  [
    { id: 'plague_wraith', name: 'Upiór Plagi',     emoji: '🧟', hpMult: 1.2, atkMult: 0.19, defMult: 0.40, baseXp: 80, baseGold: 65 },
    { id: 'bone_beast',    name: 'Kościana Bestia', emoji: '🦴', hpMult: 1.4, atkMult: 0.16, defMult: 0.55, baseXp: 75, baseGold: 58 },
    { id: 'archlich',      name: 'Arcylich',        emoji: '🧿', hpMult: 1.1, atkMult: 0.21, defMult: 0.38, baseXp: 84, baseGold: 70 },
  ],
  // Tier 5 (piętro 9–10)
  [
    { id: 'ancient_vampire', name: 'Wampir Starożytny', emoji: '🧛', hpMult: 1.2, atkMult: 0.20, defMult: 0.40, baseXp: 120, baseGold: 105 },
    { id: 'abomination',     name: 'Abominacja',        emoji: '👹', hpMult: 1.4, atkMult: 0.17, defMult: 0.52, baseXp: 114, baseGold:  98 },
    { id: 'dark_paladin',    name: 'Mroczny Paladyn',   emoji: '🗡️', hpMult: 1.1, atkMult: 0.22, defMult: 0.48, baseXp: 125, baseGold: 110 },
  ],
];
...
export const SPIDER_TEMPLATE: EnemyTemplate = {
  ...
  hpMult: 0.4, atkMult: 0.14, defMult: 0.10, baseXp: 15, baseGold: 10,
};

export const MIMIC_TEMPLATE: EnemyTemplate = {
  id: 'chest_mimic',
  name: 'Mimik Skrzyni', emoji: '🎭',
  hpMult: 1.0, atkMult: 0.22, defMult: 0.38, baseXp: 55, baseGold: 60,
};

export const BOSS_TEMPLATE: EnemyTemplate = {
  id: 'shadow_lord',
  name: 'Lord Cienia', emoji: '☠️',
  hpMult: 1.6, atkMult: 0.26, defMult: 0.42, baseXp: 280, baseGold: 350,
};
...
export function pickRandomEnemy(depth: number): EnemyTemplate {
  const tierIdx = Math.min(4, Math.floor((depth - 1) / 2));
  const pool = ENEMY_TIERS[tierIdx];
